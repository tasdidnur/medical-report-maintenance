...
@section('content')
    ...
    <div class="breadcrumbs-area">
        <h3>Fixed Reports List</h3>
        <ul>
            <li>
                <a href="">Patients</a>
            </li>
            <li>All Fixed Reports</li>
        </ul>
    </div>
            ...
            {{-- <div class=" text-right"> --}}
                <div class="row gutters-8">
                    ...
                    <div class="col-12 form-group">
                        <form class="text-right" action="{{ route('patient.fixreports') }}" method="GET">
                            <div class="row gutters-8">
                ...
                <div class="row gutters-8">
                    <div class="col-5-xxxl col-xl-5 col-lg-4 col-12 form-group d-flex">
